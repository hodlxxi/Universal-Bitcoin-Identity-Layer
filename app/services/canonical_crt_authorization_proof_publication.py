...
PUBLICATION_SCHEMA = "hodlxxi.canonical_crt_authorization_proof_publication.v1"
VERIFICATION_RESULT_SCHEMA = "hodlxxi.canonical_crt_authorization_proof_verification_result.v1"
...
_ARTIFACT_DIRECTORY = (
    Path(__file__).resolve().parents[1] / "public_artifacts" / "canonical_crt_authorization_proof" / "v1"
)
    ...
    return MappingProxyType(
        {
            ...
            "download_path": (f"/agent/crt/authorization-proofs/{artifact_id}.json"),
        }
    )
    ...
    return MappingProxyType(
        {
            ...
            "proof_basis": proof.proof_basis.value,
            "evaluated_at": proof.evaluated_at.isoformat().replace("+00:00", "Z"),
            "source_authorization_evaluation_sha256": proof.source_authorization_evaluation_sha256,
            "source_membership_evaluation_sha256": proof.source_membership_evaluation_sha256,
    ...
    return MappingProxyType(
        {
            ...
            "artifact_endpoint_template": "/agent/crt/authorization-proofs/<artifact_id>.json",
            ...
            "description": "Read-only deterministic reference artifacts; not live membership "
