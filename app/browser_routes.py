...
def register_browser_routes(
    ...
    *,
    ...
    app.add_url_rule("/", endpoint="root_redirect", view_func=root_handler, methods=["GET"])
    app.add_url_rule("/login", endpoint="login", view_func=login_handler, methods=["GET"])
    app.add_url_rule("/logout", endpoint="logout", view_func=logout_handler, methods=["GET"])
    app.add_url_rule("/playground", endpoint="playground", view_func=playground_handler, methods=["GET"])
