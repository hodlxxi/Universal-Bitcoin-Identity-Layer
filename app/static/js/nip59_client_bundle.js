var HODLXXINip59Bundle = (() => {
  ...
  var HODLXXI_NIP59_SOURCE_STATUS = Object.freeze({
  ...
  function getSourceCapabilities() {
    return Object.freeze({
      ...
      hasNip44: typeof nip44_exports === "object"
    });
  }
  function createLocalProbeEvent(nowSeconds = Math.floor(Date.now() / 1e3)) {
    ...
    return Object.freeze({
      ...
      nip44Available: typeof nip44_exports === "object"
    });
  }
  function assertNoSendAvailable() {
    return Object.freeze({
      sendEnabled: false,
      postEnabled: false,
      relayPublishing: false,
  ...
  // frontend/nip59/build/entry.js
  (function() {
    "use strict";
    const source = getSourceCapabilities();
    const noSend = assertNoSendAvailable();
    const api = Object.freeze({
      name: "hodlxxi-nip59-client",
      version: "0.0.0-p45-generated-experiment",
      status: "generated-experiment-no-send",
      cryptoReady: false,
      cryptoReadyCandidate: Boolean(source.cryptoReadyCandidate),
      canFinalizeLocalProbe: Boolean(source.hasFinalizeEvent),
      canFinalizeGiftWrap: false,
      canPostEnvelope: false,
      relayPublishing: false,
      plaintextPost: false,
      sendEnabled: false,
      dependencies: ["nostr-tools@2.23.5"],
      source,
      noSend,
