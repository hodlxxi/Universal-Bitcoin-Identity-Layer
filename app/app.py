...
register_socket_handlers(
    ...
    online_user_meta=ONLINE_USER_META,
    chat_history=CHAT_HISTORY,
    call_rooms=CALL_ROOMS,
    max_room_size=MAX_ROOM_SIZE,
    classify_presence=lambda pubkey, access_level: classify_presence(pubkey, access_level),
    purge_old_messages=lambda: purge_old_messages(),
    cleanup_old_rooms=cleanup_old_rooms,
    truncate_key=truncate_key,
)
