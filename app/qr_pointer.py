...
POINTER_REGISTRY_DIR = Path(__file__).resolve().parents[1] / "data" / "qr_pointers"
...
<p><strong>Discovery-only warning:</strong> QR possession is not authority. This page is not a receipt, verification result, trust proof, payment proof, job authority, delegation, approval, or human approval.</p>
<p>Target: <a href="{{ target }}" rel="nofollow noopener">{{ target }}</a></p>
